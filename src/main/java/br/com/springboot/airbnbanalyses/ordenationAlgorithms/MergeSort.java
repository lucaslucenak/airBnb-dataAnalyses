...
public class MergeSort {
    public static void mergeSortCrescent_Price(Integer[] arrayPrice, Integer[] auxArray1, Integer[] arrayId, Integer[] auxArray2, Integer[] arrayHostId, Integer[] auxArray3, Integer[] arrayMinimumNights, Integer[] auxArray4,
        ...
        if(ini<fim) {
            int meio= (ini+fim)/2;
            mergeSortCrescent_Price(arrayPrice,auxArray1,arrayId,auxArray2,arrayHostId,auxArray3,arrayMinimumNights,auxArray4,arrayNumberOfReviews,auxArray5,arrayCalculatedHostListingsCount,auxArray6,
    ...
    public static void mergeSortCrescent_Names(String[] arrayName, String[] auxArrayName, Integer[] arrayPrice, Integer[] auxArrayPrice, Integer[] arrayId, Integer[] auxArrayId, Integer[] arrayHostId, Integer[] auxArrayHostId, Integer[] arrayMinimumNights, Integer[] auxArrayMinimumNights, Integer[] arrayNumberOfReviews, Integer[] auxArrayNumberOfReviews, Integer[] arrayCalculatedHostListingsCount, Integer[] auxArrayCalculatedHostListingsCount, Integer[] arrayAvailability365 , Integer[] auxArrayAvailability365 ,
                                       String[] arrayHostName, String[] auxArrayHostName, String[] arrayNeighbourhoodGroup, String[] auxArrayNeighbourhoodGroup, String[] arrayNeighbourhood, String[] auxArrayNeighbourhood, String[] arrayRoomType, String[] auxArrayRoomType, String[] arrayLastReview, String[] auxArrayLastReview, Double[] arrayLatitude, Double[] auxArrayLatitude, Double[] arrayLongitude, Double[] auxArrayLongitude, Double[] arrayReviewsPerMonth, Double[] auxReviewsPerMonth, int ini, int fim) {
        if(ini<fim) {
            int meio= (ini+fim)/2;
    ...
    public static void intercarlaNames(String[] arrayName, String[] auxArrayName, Integer[] arrayPrice, Integer[] auxArrayPrice, Integer[] arrayId, Integer[] auxArrayId, Integer[] arrayHostId, Integer[] auxArrayHostId, Integer[] arrayMinimumNights, Integer[] auxArrayMinimumNights, Integer[] arrayNumberOfReviews, Integer[] auxArrayNumberOfReviews, Integer[] arrayCalculatedHostListingsCount, Integer[] auxArrayCalculatedHostListingsCount, Integer[] arrayAvailability365 , Integer[] auxArrayAvailability365 ,
                                         String[] arrayHostName, String[] auxArrayHostName, String[] arrayNeighbourhoodGroup, String[] auxArrayNeighbourhoodGroup, String[] arrayNeighbourhood, String[] auxArrayNeighbourhood, String[] arrayRoomType, String[] auxArrayRoomType, String[] arrayLastReview, String[] auxArrayLastReview, Double[] arrayLatitude, Double[] auxArrayLatitude, Double[] arrayLongitude, Double[] auxArrayLongitude, Double[] arrayReviewsPerMonth, Double[] auxReviewsPerMonth,int ini, int meio, int fim) {
