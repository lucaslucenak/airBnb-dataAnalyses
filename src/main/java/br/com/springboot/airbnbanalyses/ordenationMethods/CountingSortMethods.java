...
public class CountingSortMethods {
    ...
    public static double[] countigSort_Prices(String pathMedioCaso, String pathMelhorCaso, String pathPiorCaso, Integer[] arrayPrice, Integer[] arrayId, Integer[] arrayHostId, Integer[] arrayMinimumNights, Integer[] arrayNumberOfReviews,
        ...
        System.out.println("ARRAY NO INICIO");
        printTeste(arrayPrice, arrayId);
        //sleepTeste(5000);
        ...
        System.out.println("ARRAY DPS DO PRIMEIRO COUNBTIGN SORT (ORDENOU)");
        printTeste(arrayPrice, arrayId);
        //sleepTeste(5000);
        ...
        System.out.println("ARRAY ORDENADO AO CONTRARIO PELO SELECTION");
        printTeste(arrayPrice, arrayId);
        //sleepTeste(10000);
        ...
        System.out.println("ULTIMA ORDENACAO DO ARRAYYYYY");
        printTeste(arrayPrice, arrayId);
        //sleepTeste(10000);
